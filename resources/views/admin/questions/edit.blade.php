        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800"><i class="fa-solid fa-pen-to-square" style="color: red;"></i> <span style="color: #209CEE">{{ __('Modifier question')}}</span></h1>
            ...
            <div class="card-body">
                <form action="{{ route('admin.questions.update', $question->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="question_text" placeholder="{{ __('Question ') }}" name="question_text" value="{{ old('question_text', $question->question_text) }}" />
                    </div>
                    <div class="form-group">
